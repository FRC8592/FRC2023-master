...
public enum Trajectories {
    ...
    BOTTOM_CROSS_LINE_1("output/BottomCrossLine1.wpilib.json", Rotation2d.fromDegrees(0), true),

    // Score Pre-load && Park [*Bottom Start*][*Blue*](21 pts)

    BOTTOM_1_CUBE_PARK("output/Bottom1CubePark.wpilib.json", Rotation2d.fromDegrees(0), true),


    // Cross Line and Balance Charge Station [*Middle Start*][*Blue*](15 pts)

    MID_PARK_1("output/MidPark1.wpilib.json", Rotation2d.fromDegrees(0), true),
    MID_PARK_2("output/MidPark2.wpilib.json", Rotation2d.fromDegrees(0), true),

    // COME UP WITH STUFF FOR THIS

    MID_2_CUBE_PARK_1("output/Mid2CubePark1.wpilib.json", Rotation2d.fromDegrees(0), true),
    MID_2_CUBE_PARK_2("output/Mid2CubePark2.wpilib.json", Rotation2d.fromDegrees(0), true),
    MID_2_CUBE_PARK_3("output/Mid2CubePark3.wpilib.json", Rotation2d.fromDegrees(0), true),

    // Score Pre-load and second game piece [*Bottom Start*][*Blue*](13 pts)

    BOTTOM_2_CUBE_1("output/Bottom2Cube1.wpilib.json", Rotation2d.fromDegrees(0), true),
    BOTTOM_2_CUBE_2("output/Bottom2Cube2.wpilib.json", Rotation2d.fromDegrees(0), true),
