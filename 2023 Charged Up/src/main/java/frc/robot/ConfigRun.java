...
public final class ConfigRun {
    ...
    public static final double ROTATE_POWER_FAST    = 0.5;      // Scaling for teleop driving.  1.0 is maximum
    ...
    //
    public static final double MAX_SWERVE_DRIVE_TELEOP_CURRENT = 20.0; // Lower values will reduce acceleration //40.0
