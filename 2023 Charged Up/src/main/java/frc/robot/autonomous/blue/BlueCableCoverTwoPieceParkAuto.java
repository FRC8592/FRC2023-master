...
public class BlueCableCoverTwoPieceParkAuto extends BaseAuto {
    ...
    private Trajectory GP3_TO_BM = TrajectoryGenerator.generateTrajectory(
        GAME_PIECE_3.getPose(),
    ...
    public void initialize() {
        queue = new CommandQueue(
            ...
            new FollowerCommand(drive, new SwerveTrajectory(GP3_TO_BM), Rotation2d.fromDegrees(0), "GP3 -> BM"),
