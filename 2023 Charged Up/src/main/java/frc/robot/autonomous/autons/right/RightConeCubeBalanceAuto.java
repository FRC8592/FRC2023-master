...
public class RightConeCubeBalanceAuto extends BaseAuto {
    ...
    private SwerveTrajectory G_TO_Icc = generate(
        fastConfig
            ...
            .setReversed(false),
        GRID_G.getPose(),
        INTERMEDIARY_CABLE_COVER.translate(-2.5, -0.1),
    ...
    private SwerveTrajectory GP4_TO_Icc = generate(
        ...
        GAME_PIECE_4.translate(-2.5, 0.05)
    ...
    private SwerveTrajectory H_TO_BALANCE = generate(
        slowConfig
            ...
            .setReversed(false),
        GAME_PIECE_4.translate(-3.9, 0.05),
        GAME_PIECE_4.translate(-3.9, 0.1),
        GAME_PIECE_4.translate(-3.7, 1.0),
        GAME_PIECE_4.translate(-3.5, 1.4),
        GAME_PIECE_4.translate(-2.4, 1.4)
    );
    ...
    public void initialize() {
        queue = new CommandQueue(
            ...
            new JointCommand(
                ...
                new FollowerCommand(drive, GP4_TO_Icc.addRotation(new Rotation2d(), 2 * Math.PI, 0.25)),
                new LiftCommand(elevator, Heights.PRIME)
            ),
            new JointCommand(
            ...
            new JointCommand(
                new LiftCommand(elevator, Heights.STOWED),
                new FollowerCommand(drive, H_TO_BALANCE.addRotation(Rotation2d.fromDegrees(180), 2 * Math.PI, 0.75))
            ),
            new JointCommand(
