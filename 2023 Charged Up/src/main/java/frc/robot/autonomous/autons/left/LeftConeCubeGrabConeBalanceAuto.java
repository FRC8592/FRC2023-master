...
public class LeftConeCubeGrabConeBalanceAuto extends BaseAuto {
    ...
    ).addRotation(Rotation2d.fromDegrees(180), Math.PI / 4, 0.5);
    ...
    ).addRotation(Rotation2d.fromDegrees(180), Math.PI / 4, 0.0).addVision();
    ...
    private SwerveTrajectory GP2_TO_BM = generate(
        fastConfig
            ...
            .setEndVelocity(0.0)
            .setReversed(true),
        GAME_PIECE_2.translate(0.25, -0.1),
    ...
    public void initialize() {
        queue = new CommandQueue(
            ...
            new JointCommand( // Move to second piece
                ...
                new IntakeCommand(intake, 2.0, true),
            ...
            new FollowerCommand(drive, GP2_TO_BM), // Move to charging station
            new JointCommand( // Balance and throw third piece
